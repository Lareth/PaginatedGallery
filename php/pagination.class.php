...
class Pagination {
	...
	private function bauePagination(){												//Funktion zum Bauen der Pagination
		...
		if($this->gesamteSeitenZahl > 1){
			...
			if($this->gesamteSeitenZahl < $this->dargestellteSeiten ){		//Wenn es gar nicht so viele Seiten gibt, m�ssen weniger Seiten generiert werden
